...
const achievements = [
    {
        ...
        type: 'Hackathon',
        description:
            'Participated in the prestigious Quantum Valley Hackathon, competing against teams from top engineering colleges across the region. Developed an innovative AI solution within a 24-hour sprint, showcasing problem-solving skills and technical depth.',
        highlights: [
            'Competed among 100+ teams from top institutions',
            'Built an AI prototype in under 24 hours',
            'Recognized for innovative approach to real-world problem solving',
            ...
            <div className="max-w-5xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-400 max-w-xl mx-auto text-base">
                        Milestones that reflect dedication, innovation, and competitive excellence.
                    </p>
                </motion.div>
                            ...
                            <div className="p-8 md:p-10">
                                <div className="flex flex-col md:flex-row gap-6 items-start">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <h3 className="font-grotesk text-2xl font-bold text-white mb-1">{item.title}</h3>
                                        <p className="text-yellow-400/70 font-medium text-sm mb-4">{item.organization}</p>
                                        ...
                                        <div className="grid sm:grid-cols-2 gap-3">
                                            {item.highlights.map((highlight, j) => (
                                                ...
                                                >
                                                    <FiStar className="text-yellow-400 mt-0.5 flex-shrink-0" size={14} />
                ...
                >
                    {[
                        ...
                        <div key={stat.label} className="glass rounded-2xl p-5 text-center border border-violet-600/20">
                            <stat.icon className="text-violet-400 mx-auto mb-2" size={20} />
