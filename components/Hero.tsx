        ...
        >
            ...
            >
                ...
                <motion.div variants={itemVariants} className="mb-6">
                    ...
                    <div className="mx-auto mt-3 w-24 h-0.5 bg-gradient-to-r from-transparent via-violet-500 to-transparent animate-gradient" />
                </motion.div>
                ...
                >
                    Passionate MCA student with a <span className="text-violet-300 font-medium">9.0 CGPA</span>, specializing in
                    Artificial Intelligence and Full Stack development. I build intelligent, scalable solutions — from
                    AI-powered transcription systems to full-stack web applications — driven by curiosity and a love for
